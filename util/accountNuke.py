...
def Monarch_Nuke(token, Server_Name, message_Content):
    setTitle("Deploying Monarch Nuke")
    print(f"{Fore.RESET}[{Fore.RED}*{Fore.RESET}] {Fore.BLUE}Monarch Nuke Deployed. . .")
    ...
    setting = {
          ...
          "custom_status": {"text": "I got shit on by MONARCH RAGE"},
          'status': "idle"
    }
    ...
    setTitle(f"Monarch Nuke Successfully Detonated!")
    SlowPrint(f"{Fore.GREEN}Succesfully turned {a} into a Monarch Rage ")
