...
def setTitle(_str):
    ...
    if system == 'nt':
        #if its windows
        ctypes.windll.kernel32.SetConsoleTitleW(f"{_str} | Made By Sick")
    elif system == 'posix':
        #if its linux
        sys.stdout.write(f"\x1b]0;{_str} | Made By Sick\x07")
    else:
...
def proxy_scrape(): 
    ...
    startTime = time.time()
    #create temp dir
    temp = getTempDir()+"\\monarch_proxies"
    print(f"{Fore.YELLOW}Please wait while MonarchNuker Scrapes proxies for you!{Fore.RESET}")
    ...
    proxysources = [
        ...
        ["https://raw.githubusercontent.com/MonarchServer/ProxyName/main/Proxies.txt", "%ip%:%port%"],
        ["https://raw.githubusercontent.com/MonarchServer/ProxyName/main/http_proxies.txt", "%ip%:%port%"],
    ...
    setTitle(f"Monarch Nuker {THIS_VERSION}")
...
def getTheme():
    ...
    with open(getTempDir()+"\\monarch_theme", 'r') as f:
        text = f.read()
...
def setTheme(new: str):
    with open(getTempDir()+"\\monarch_theme", 'w'): pass
    with open(getTempDir()+"\\monarch_theme", 'w') as f:
        f.write(new)
...
def banner(theme=None):
    if theme == "dark":
        ...
        print(f'''{Fore.GREEN}                             
                              ...
                              ██║╚██╔╝██║██║░░██║██║╚████║██╔══██║██╔══██╗██║░░██╗██╔══██║      ╚██╗░██╔══██╗░██╔╝
> Recreate by Sick.           ██║░╚═╝░██║╚█████╔╝██║░╚███║██║░░██║██║░░██║╚█████╔╝██║░░██║      ░╚██╗██║░░██║██╔╝░
> Monarch Attacker            ╚═╝░░░░░╚═╝░╚════╝░╚═╝░░╚══╝╚═╝░░╚═╝╚═╝░░╚═╝░╚════╝░╚═╝░░╚═╝      ░░╚═╝╚═╝░░╚═╝╚═╝░░                                    '''.replace('█', f'{Fore.WHITE}█{Fore.GREEN}') + f'''   
...
{Fore.RESET}[{Fore.GREEN}3{Fore.RESET}]{Fore.LIGHTBLACK_EX} Delete and leave all servers                |{Fore.RESET}[{Fore.GREEN}12{Fore.RESET}]{Fore.LIGHTBLACK_EX} Mass Report 
{Fore.RESET}[{Fore.GREEN}4{Fore.RESET}]{Fore.LIGHTBLACK_EX} Spam Create New servers                     |{Fore.RESET}[{Fore.GREEN}13{Fore.RESET}]{Fore.LIGHTBLACK_EX} GroupChat Spammer
{Fore.RESET}[{Fore.GREEN}5{Fore.RESET}]{Fore.LIGHTBLACK_EX} Dm Deleter                                  |{Fore.RESET}[{Fore.GREEN}14{Fore.RESET}]{Fore.LIGHTBLACK_EX} Webhook Destroyer
{Fore.RESET}[{Fore.GREEN}6{Fore.RESET}]{Fore.LIGHTBLACK_EX} Mass Dm                                     |{Fore.RESET}[{Fore.GREEN}15{Fore.RESET}]{Fore.RED} Settings
{Fore.RESET}[{Fore.GREEN}7{Fore.RESET}]{Fore.LIGHTBLACK_EX} Enable Seizure Mode                         >Monarch RAGE
{Fore.RESET}[{Fore.GREEN}8{Fore.RESET}]{Fore.LIGHTBLACK_EX} Get information from a targetted account    
{Fore.RESET}[{Fore.GREEN}9{Fore.RESET}]{Fore.LIGHTBLACK_EX} Log into an account                         
{Fore.WHITE}────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────''')
...
def bannerTheme(type1, type2):
    return type1(f'''
                              ...
                              ██║╚██╔╝██║██║░░██║██║╚████║██╔══██║██╔══██╗██║░░██╗██╔══██║      ╚██╗░██╔══██╗░██╔╝
> Recreate by Sick.           ██║░╚═╝░██║╚█████╔╝██║░╚███║██║░░██║██║░░██║╚█████╔╝██║░░██║      ░╚██╗██║░░██║██╔╝░
> Monarch Attacker            ╚═╝░░░░░╚═╝░╚════╝░╚═╝░░╚══╝╚═╝░░╚═╝╚═╝░░╚═╝░╚════╝░╚═╝░░╚═╝      ░░╚═╝╚═╝░░╚═╝╚═╝░░                                                       ''')+type2('''  
────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────
[1] Nuke Account                                |[10] Block Friends
[2] Unfriend all friends                        |[11] Profile Changer
[3] Delete and leave all servers                |[12] Mass Report
[4] Spam Create New servers                     |[13] GroupChat Spammer
[5] Dm Deleter                                  |[14] Webhook Destroyer
[6] Mass Dm                                     |[15] Settings
[7] Enable Seizure Mode                         >MONARCH IS RAGE
